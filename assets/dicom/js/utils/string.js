 ...
 */
BAMBOO.utils.capitaliseFirstLetter = function (string)
{
    var res = string;
    if ( string ) {
 ...
 */
BAMBOO.utils.cleanString = function (string)
{
    var res = string;
    if ( string ) {
        // trim spaces
 ...
 */
BAMBOO.utils.splitQueryString = function (inputStr)
{
    // result
    var result = {};
    ...
    if ( inputStr && (sepIndex = inputStr.indexOf('?')) !== -1 ) {
        ...
        result.query = BAMBOO.utils.splitKeyValueString(query);
    }
    // return
    return result;
};
 ...
 * @return {Object} The split string.
 */
BAMBOO.utils.splitKeyValueString = function (inputStr)
{
    // result
    var result = {};
    // check input string
