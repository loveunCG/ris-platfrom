 ...
 */ 
BAMBOO.tool.RectangleCreator = function (points, style)
{
    // physical shape
    var rectangle = new BAMBOO.math.Rectangle(points[0], points[points.length-1]);
    // shape
 ...
 */ 
BAMBOO.tool.UpdateRect = function (rect, anchor)
{
    // parent group
