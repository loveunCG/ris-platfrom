 ...
 * @static
 */
BAMBOO.info.createWindowingDiv = function()
{
    var div = document.getElementById("infotr");
    BAMBOO.html.removeNode("ulinfotr");
    // windowing list
 ...
 * @static
 */
BAMBOO.info.createPositionDiv = function()
{
    var div = document.getElementById("infotl");
    BAMBOO.html.removeNode("ulinfotl");
    // position list
    var ul = document.createElement("ul");
    ul.id = "ulinfotl";
    // position
 ...
 * @static
 */
BAMBOO.info.createMiniColorMap = function()
{    
    // color map
    var div = document.getElementById("infobr");
    BAMBOO.html.removeNode("canvasinfobr");
 ...
 */
BAMBOO.info.updateMiniColorMap = function(event)
{    
 ...
 * @static
 */
BAMBOO.info.createPlot = function()
{
 ...
 */
BAMBOO.info.updatePlotMarkings = function(event)
{
    var wc = event.wc;
    var ww = event.ww;
