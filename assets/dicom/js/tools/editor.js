 ...
 * @constructor
 */
BAMBOO.tool.ShapeEditor = function ()
{
    /**
     * Edited shape.
     * @property shape
    ...
    function addAnchors() {
        ...
        if ( shape instanceof Kinetic.Line ) {
            ...
            if ( points.length === 4 ) {
                updateFunction = BAMBOO.tool.UpdateLine;
                // add shape offset
                ...
                updateFunction = BAMBOO.tool.UpdateRoi;
                var px = 0;
                var py = 0;
            ...
            updateFunction = BAMBOO.tool.UpdateRect;
            var rectX = shape.x();
            var rectY = shape.y();
            ...
            updateFunction = BAMBOO.tool.UpdateEllipse;
    ...
    function setAnchorOn( anchor ) {
        ...
        anchor.on('dragend', function () {
            ...
            var chgcmd = new BAMBOO.tool.ChangeShapeCommand(
