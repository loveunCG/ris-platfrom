 ...
 * @input cost_functor
 */
BAMBOO.math.BucketQueue = function(bits, cost_functor)
{
...
BAMBOO.math.BucketQueue.prototype.push = function(item) {
...
BAMBOO.math.BucketQueue.prototype.pop = function() {
    if ( this.size === 0 ) {
...
BAMBOO.math.BucketQueue.prototype.remove = function(item) {
...
BAMBOO.math.BucketQueue.prototype.isEmpty = function() {
    return this.size === 0;
};

BAMBOO.math.BucketQueue.prototype.getBucket = function(item) {
    // Bucket index is the masked cost
    return this.cost(item) & this.mask;
};

BAMBOO.math.BucketQueue.prototype.buildArray = function(newSize) {
