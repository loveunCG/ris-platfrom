...
window.RTCMultiConnection = function (roomid, forceOptions) {
	...
	function PeerInitiator(config) {
		...
		function oldAddRemoteSdp(remoteSdp, cb) {
			cb = cb || function () {}, remoteSdp.sdp = connection.processSdp(remoteSdp.sdp), peer.setRemoteDescription(new RTCSessionDescription(remoteSdp), cb, function (error) {
		...
		window.enableAdapter || (incomingStreamEvent = "addstream"), peer.addEventListener(incomingStreamEvent, function (event) {
			...
			return cb = cb || function () {}, window.enableAdapter ? (remoteSdp.sdp = connection.processSdp(remoteSdp.sdp), void peer.setRemoteDescription(new RTCSessionDescription(remoteSdp)).then(cb, function (error) {
				connection.enableLogs && console.error("setRemoteDescription failed", "\n", error, "\n", remoteSdp.sdp), cb()
