        ...
        o = function(a) {
          ...
          if (0 != l.length) {
            var o = new Date,
              ...
              r = "";
            r += '<li class="out">', r += '<img class="avatar" alt="" src="' + Layout.getLayoutImgPath() + 'avatar1.jpg"/>', r += '<div class="message">', r += '<span class="arrow"></span>', r += '<a href="#" class="name">'+d+'</a>&nbsp;', r += '<span class="datetime">at ' + n + "</span>", r += '<span class="body">', r += l, r += "</span>", r += "</div>", r += "</li>";
...
//rch changed
                $.ajax({
                    ...
                    url: $("#sub_url").val(),                    
                    data: {
                      'post_content': l, 'lession_id':$("#movie_id").val()
                    },
    ...
    initAmChart3: function() {
      if ("undefined" != typeof AmCharts && 0 !== $("#dashboard_amchart_3").size()) {
        AmCharts.makeChart("dashboard_amchart_3", {
          ...
          addClassNames: !0,
          theme: "light",
          path: "<?=base_url()?>"+"assets/global/plugins/amcharts/ammap/images/",
          autoMargins: !1,
          marginLeft: 30,
          marginRight: 8,
          marginTop: 10,
