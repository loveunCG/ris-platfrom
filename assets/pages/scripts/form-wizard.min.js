    ...
    return {
        init: function() {
            ...
            if (jQuery().bootstrapWizard) {
                ...
                var a = function() {
                    ...
                    o = function(e, r, t) {
                        var i = r.find("li").length,
                            o = t + 1;
                        $(".step-title", $("#form_wizard_1")).text("第 " + (t + 1) + " 步 共 " + i + " 步"), jQuery("li", $("#form_wizard_1")).removeClass("done");
                ...
                }), $("#form_wizard_1").find(".button-previous").hide(), $("#form_wizard_1 .button-submit").hide(), $("#country_list", r).change(function() {
