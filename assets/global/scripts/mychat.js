...
$(function() {
    ...
    function createChatMessage(msg, user, imgg, now) {
        ...
        var r = [];
        r += '<li class="' + who + '">',
            r += '<img class="avatar" alt="" src="' + getLayoutImgPath() + avatar + '"/>',
            r += '<div class="message">',
            r += '<span class="arrow"></span>',
            r += '<a href="#" class="name">' + user + '</a>&nbsp;',
            r += '<span class="datetime">at ' + now + "</span>",
            r += '<span class="body">',
            r += msg,
            r += "</span>",
            r += "</div>",
    ...
    $("body").on("click", ".message .name", function(e) {
        e.preventDefault();
        var t = $(this).text();
        textarea.val("@" + t + ":"), App.scrollTo(textarea);
    })
