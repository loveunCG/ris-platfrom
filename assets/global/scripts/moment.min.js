// ! moment.js ! version : 2.5.1 ! authors : Tim Wood, Iskren Chernev, Moment.js
...
(function(a) {
    ...
    function w(a) {
        var b;
        a._a && -2 === a._pf.overflow && (b = a._a[jb] < 0 || a._a[jb] > 11 ?
            jb :
            ...
            ob :
            -1, a._pf._overflowDayOfYear && (ib > b || b > kb) && (b = kb), a._pf.overflow = b)
    }
    ...
    function C(a) {
        ...
        for (; f < a.length;) {
            for (e = y(a[f]).split("-"), b = e.length, d = y(a[f + 1]), d = d ?
                d.split("-") :
                null; b > 0;) {
        ...
        if (!a._d) {
            for (d = M(a), a._w && null == a._a[kb] && null == a._a[jb] && (f = function(b) {
                    ...
                    (i = C(a._l), j = null != g.d ?
                        ...
                        0, k = parseInt(g.w, 10) || 1, null != g.d && j < i._week.dow && k++, h = Z(f(g.gg), k, j, i._week.doy, i._week.dow)),
                    a._a[ib] = h.year,
                    a._dayOfYear = h.dayOfYear), a._dayOfYear && (e = null == a._a[ib] ?
                    d[ib] :
                    a._a[ib], a._dayOfYear > u(e) && (a._pf._overflowDayOfYear = !0), c = U(e, 0, a._dayOfYear), a._a[jb] = c.getUTCMonth(), a._a[kb] = c.getUTCDate()), b = 0; 3 > b && null == a._a[b]; ++b)
                a._a[b] = l[b] = d[b];
            for (; 7 > b; b++)
                a._a[b] = l[b] = null == a._a[b] ?
                2 === b ?
                1 :
                0 :
                a._a[b];
    ...
    function N(a) {
        ...
        for (d = G(a._f, g).match(vb) || [], b = 0; b < d.length; b++)
            ...
            (c ?
                a._pf.empty = !1 :
                a._pf.unusedTokens.push(e), J(e, c, a)) :
    ...
    function X(a, b, c) {
        var d = hb(Math.abs(a) / 1e3),
            ...
            g = hb(f / 24),
            h = hb(g / 365),
            i = 45 > d && ["s", d] || 1 === e && ["m"] || 45 > e && ["mm", e] || 1 === f && ["h"] || 22 > f && ["hh", f] || 1 === g && ["d"] || 25 >= g && ["dd", g] || 45 >= g && ["M"] || 345 > g && [
                "MM",
                hb(g / 30)
            ] || 1 === h && ["y"] || ["yy", h];
        return i[2] = b,
    ...
    function $(a) {
        ...
        return null === b ?
            ...
            ("string" == typeof b && (a._i = b = C().preparse(b)), db.isMoment(b) ?
    ...
    function cb(a) {
        var b = !1,
            c = db;
        "undefined" == typeof ender && (a ?
            (gb.moment = function() {
                    return !b && console && console.warn && (b = !0, console.warn("Accessing Moment through the global scope is deprecated, and will be removed in " +
                            "an upcoming release.")),
    ...
    for (Yb.DDDD = c(Yb.DDD, 3), h(e.prototype, {
            ...
            _months: ("January_February_March_April_May_June_July_August_September_October_November_De" +
                "ember").split("_"),
            months: function(a) {
        ...
        db.lang = function(a, b) {
            ...
            return a ?
                (b ?
                    ...
                    null === b ?
                    (B(a), a = "en") :
                    pb[a] || C(a), c = db.duration.fn._lang = db.fn._lang = C(a), c._abbr) :
                db.fn._lang._abbr
        },
    ...
    for (db.normalizeUnits = function(a) {
        ...
        h(db.fn = f.prototype, {
            ...
            isDSTShifted: function() {
                return this._a ?
                    this.isValid() && o(this._a, (this._isUTC ?
                        db.utc(this._a) :
                        db(this._a)).toArray()) > 0 :
                    !1
            },
            ...
            diff: function(a, b, c) {
                ...
                return b = p(b),
                    "year" === b || "month" === b ?
                    (d = 432e5 * (this.daysInMonth() + f.daysInMonth()), e = 12 * (this.year() - f.year()) + (this.month() - f.month()), e += (this - db(this).startOf("month") - (f - db(f).startOf("month"))) / d, e -= 6e4 * (this.zone() - db(this).startOf("month").zone() - (f.zone() - db(f).startOf("month").zone())) / d, "year" === b && (e /= 12)) :
                    (d = this - f, e = "second" === b ?
                        d / 1e3 :
                        "minute" === b ?
                        d / 6e4 :
            ...
            month: function(a) {
                var b,
                    ...
                    "";
                return null != a ?
                    "string" == typeof a && (a = this.lang().monthsParse(a), "number" != typeof a) ?
                    this :
                    (b = this.date(), this.date(1), this._d["set" + c + "Month"](a), this.date(Math.min(b, this.daysInMonth())), db.updateOffset(this), this) :
                    this._d["get" + c + "Month"]()
            },
            startOf: function(a) {
                switch (a = p(a)) {
            ...
            zone: function(a) {
                ...
                return null == a ?
                    ...
                    ._d
                    .getTimezoneOffset() :
                    ("string" == typeof a && (a = I(a)), Math.abs(a) < 16 && (a = 60 * a), this._offset = a, this._isUTC = !0, b !== a && l(this, db.duration(b - a, "m"), 1, !0), this)
            },
            zoneAbbr: function() {
                return this._isUTC ?
                    "UTC" :
    ...
    bb("Weeks", 6048e5),
        ...
        define("moment", function(b, c, d) {
            return d.config && d.config() && d
                .config()
                .noGlobal !== !0 && cb(d.config().noGlobal === a),
                db
        }) :
        cb()
}).call(this);