            ...
            <form action="<?=base_url()?>report/save_delberation" id="deliberation_submit" method="post">
                                ...
                                <div class="portlet mt-element-ribbon portlet-sortable box blue-madison portlet-fit ">
                                    ...
                                    <div class="portlet-title">
                                        <div class="caption">
                                            ...
                                            <span class="font-light bold uppercase"><?=$this->lang->line('image_expression')?></span>
                                        </div>
                                    </div>
                                    <div class="portlet-body">
                                                ...
                                                <div class="form-body">
                                                    <div class="form-group last">
                                                        <div class="form-group">
                                                            <textarea class="form-control autosizeme col-md-12 bg-white" readonly name="Imaging_performance" rows="8">
                                    ...
                                    <div class="portlet-body">
                                        <div class="form-group form-md-radios">
                                            <div class="md-radio-inline">
                                                <div class="md-radio">
                                                    <input type="radio" disabled id="radio14" name="positive_status" value="1" class="md-radiobtn" <?php if ($value->positive_status=='1')
                                                    { echo 'checked=""'; } ?>>
                                                    <label for="radio14">
                                                    <span class="inc"></span>
                                                ...
                                                <div class="md-radio has-error">
                                                    <input disabled type="radio" id="radio15" value="2" name="positive_status" class="md-radiobtn" <?php if ($value->positive_status=='2')
                                                    { echo 'checked=""'; }?>>
                                                    <label for="radio15">
                                                    <span class="inc"></span>
                                                    <span class="check"></span>
                                                ...
                                                <div class="md-radio has-warning">
                                                    <input disabled type="radio" id="radio16" value="3" name="positive_status" class="md-radiobtn" <?php if ($value->positive_status=='3')
                                                    { echo 'checked=""'; }?>>
                                                    <label for="radio16">
                                                    <span class="inc"></span>
                                                    <span class="check"></span>
                                        ...
                                        <div class="form-group form-md-radios">
                                            ...
                                            <div class="md-radio-inline">
                                                <div class="md-radio">
                                                    <input disabled type="radio" id="radio17" name="urgency_status" value="0" class="md-radiobtn" <?php if ($value->urgency_status=='0')
                                                    { echo 'checked=""'; }?>>
                                                    <label for="radio17">
                                                    <span class="inc"></span>
                                                    <span class="check"></span>
                                                ...
                                                <div class="md-radio has-error">
                                                    <input disabled type="radio" id="radio19" name="urgency_status" value="1" class="md-radiobtn" <?php if ($value->urgency_status=='1')
                                                    { echo 'checked=""'; }?>>
                                                    <label for="radio19">
                                                    <span class="inc"></span>
                                                    <span class="check"></span>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="portlet mt-element-ribbon portlet-sortable box blue-madison portlet-fit ">
                                    ...
                                    <div class="portlet-title">
                                        <div class="caption">
                                            <i class=" icon-layers font-green"></i>
                                            <span class="caption-subject font-green bold uppercase"><?=$this->lang->line('clinical_diagnosis')?></span>
                                        </div>
                                    </div>
                                    <div class="portlet-body">
                                        <div class="portlet-body form">
                                            <div class="form-horizontal form-bordered">
                                                <div class="form-body">
                                                    <div class="form-group last">
                                                        <div class="form-group">
                                                            <textarea class="form-control autosizeme  col-md-12 bg-white" name="impression" disabled rows="6"><?=$value->impression?></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="portlet mt-element-ribbon portlet-sortable box blue-madison portlet-fit ">
                                    ...
                                    <div class="portlet-title">
                                        <div class="caption">
                                            <i class=" icon-layers font-green"></i>
                                            <span class="caption-subject font-light bold uppercase"><?=$this->lang->line('suggestion')?></span>
                                        </div>
                                    </div>
                                    <div class="portlet-body">
                                        <div class="portlet-body form">
                                            <div class="form-horizontal form-bordered">
                                                <div class="form-body">
                                                    <div class="form-group last">
                                                        <div class="form-group">
                                                            <textarea class="form-control autosizeme col-md-12 bg-white" name="recommend_report" disabled rows="6"><?=$value->recommend_report?></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <div class="input-group col-md-12">
                                                                <textarea class="form-control" name="deliberation_content" rows="6"></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                ...
                <div class="row">
                    <div class="m-heading-1 border-green m-bordered">
                        <div class="row">
                            <a onclick="history.go(-1);" class=" col-md-offset-3 col-md-1 btn green"><span class="glyphicon glyphicon-chevron-left"> </span>返回</a>
                            ...
                            <button type="button" class="col-md-offset-1  col-md-1 btn red-mint uppercase " onclick="nopass_deli(<?=$report_table->delivery_name?>)"><span class="glyphicon glyphicon-share-alt"></span>回退</button>
                            <button type="button" id="submit_deliberation_btn" class="col-md-offset-1 col-md-1 btn yellow-mint uppercase " data-toggle="confirmation"
                                id=""><span class="glyphicon glyphicon-floppy-saved"> </span>审核通过</button>
