<div class="page-content-wrapper">
                            ...
                            <div class="form-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class=" col-md-3 form-group form-md-input">
                                        <button type="button" class="pull-left btn col-md-4 blue  yellow" id="search_report_btn"><span class="glyphicon glyphicon-search"> </span>检查</button>
                                        <button type="button" class="btn pull-right col-md-4 blue " onclick="search_clear()"><span class="glyphicon glyphicon-refresh"> </span>重置</button>
                                    </div>
                                </div>
                            </div>
                        </form>
                ...
                <div class="portlet portlet-sortable box blue-madison portlet-datatable ">
                    ...
                    <div class="portlet-body">
                        <div class="clearfix" style="margin-left: 10%;">
                          <button type="button" class="btn blue" id="report_detail_view" disabled onclick="report_detail_view()"><span class="glyphicon glyphicon-eye-open"> </span>查看</button>
                          <button type="button" id = "dicom_view_btn" disabled class="btn green" onclick="dicom_view()"><span class="glyphicon glyphicon-picture"> </span>调图</button>
                          <button type="button" disabled id= "report_btn" onclick="make_report()" disabled class="btn btn-primary"><span class="glyphicon glyphicon-send"> </span>诊断报告</button>
                          <button type="button" disabled  class="btn  red-mint" id="contact_proc" onclick=""><span class="glyphicon glyphicon-share"> </span>智能诊断</button>
                          <button type="button" disabled  class="btn  yellow-mint" id="remote_contact_proc_btn" onclick="remote_contact_proc()"><span class="glyphicon glyphicon-share"> </span>远程诊断</button>
                        </div>
                ...
                <div class="portlet portlet-sortable box blue-madison ">
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <span class="caption-subject font-green sbold uppercase">  <?=$this->lang->line('past_checkup')?></span>
                        </div>
  ...
  function past_checkup_info(val) {
      ...
      if (booking_status== '1') {
        ...
        $('#dicom_view_btn').removeAttr('disabled');
        $("#report_btn").attr("disabled", "true");
        $('#contact_proc').removeAttr('disabled');
        $('#report_detail_view').removeAttr('disabled');
          ...
          if (report_data) {
              ...
              for (var i = 0; i < count; i++) {
                  ...
                  if (report_data.tdata[i].patient_gender == '1') {
                      ...
                      var gender = '<button type="button" class="btn btn-circle btn-icon-only blue"><span aria-hidden="true" class="icon-symbol-male"></span></button>';
                  }
