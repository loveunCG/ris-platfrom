...
<form action="<?=base_url()?>report/save_delberation" id="report_submit" method="post">
                                                    ...
                                                    <div class="scroller" style="height:200px" data-rail-visible="1" data-rail-color="yellow" data-handle-color="#a1b2bd">
                                                        ...
                                                        <div class="form-group form-md-radios">
                                                            <div class="md-radio-inline">
                                                                <div class="md-radio">
                                                                    <input disabled type="radio" id="radio14" name="positive_status" value="1" class="md-radiobtn" <?php if ($value->positive_status=='1')
                                                                    { echo 'checked=""'; } ?>>
                                                                    <label for="radio14">
                                                                      <span class="inc"></span>
  ...
  <div class="row">
    <div class="m-heading-1 border-green m-bordered">
        <div class="row">
            <a onclick="history.go(-1);" class=" col-md-offset-5 col-md-1 btn-circle btn green"><i class="fa fa-undo"></i>返回</a>
