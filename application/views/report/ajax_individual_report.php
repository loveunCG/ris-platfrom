			...
			<div class="col-md-12">
				<div class="portlet portlet-sortable box blue-madison portlet-datatable ">
                  ...
                  <th style="text-align: center;">医院申请医生</th>
									<th style="text-align: center;">诊断来源</th>
...
<script src="<?=base_url()?>assets/global/scripts/iziModal.min.js" type="text/javascript"></script>
	<script>
		...
		function searchByTime() {
			...
			var base_url = '<?=base_url()?>';
			var ajaxurl = base_url + 'report/search_individual_report?' + form_data;
			console.log(ajaxurl)
		...
		$(document).ready(function () {
			var tbl_usr_info = '<?=base_url()?>' + 'report/search_individual_report';
			...
			$("#search_report_btn").click(function () {
				...
				var ajaxurl = base_url + 'report/search_individual_report?' + formData;
				table.ajax.url(ajaxurl).load();
			});
