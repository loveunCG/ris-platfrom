									...
									<div class="form-body">
										...
										<div class="row">
											...
											<div class=" col-lg-3 col-md-6 form-group form-md-input">
												<button type="button" class="pull-left btn col-md-4 blue  yellow" id="search_report_btn">
													<span class="glyphicon glyphicon-search"> </span>查询</button>
												<button type="button" class="btn pull-right col-md-4 blue " onclick="search_clear()">
						...
						<div class="portlet portlet-sortable box blue-madison portlet-datatable ">
							...
							<div class="portlet-body">
								<div class="clearfix" style="margin-left: 10%;">
									<button type="button" class="btn blue-hoki" id="deliberation_detail_view" disabled onclick="deliberation_view()">
										<span class="glyphicon glyphicon-eye-open"> </span>查看</button>
									<?php $usrRole = $this->session->userdata('usr_role')?>
									<?php if ($usrRole == 1||$usrRole == 100||$usrRole == 10||$usrRole == 1024||$this->session->userdata('Audit')):?>
									<button type="button" disabled id="make_deliberation_btn" onclick="make_deliberation()" class="btn btn-primary">
