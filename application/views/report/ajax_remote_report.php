...
<div class="row" id="sortable_portlets">
                                ...
                                <div class="col-lg-12 col-md-12 form-group form-md-line-input">
                                    ...
                                    <div class="col-md-10">
                                        <div class="md-radio-inline">
                                            <div class="md-radio ">
                                                <input type="radio" id="radio54" name="data_type" value="1" class="md-radiobtn" checked>
                                                <label for="radio54">
                                                    <span></span>
                                                    <span class="check"></span>
                                                    <span class="box"></span> 我发起的</label>
                                            </div>
                                              <div class="md-radio ">
                                                <input type="radio" id="radio541" name="data_type" value="2" class="md-radiobtn" checked>
                                                <label for="radio541">
                                                  <span></span>
                                                  <span class="check"></span>
                                                  <span class="box"></span> 我接收的</label>
                                              </div>
                                              <div class="md-radio ">
                                                <input type="radio" id="radio523" name="data_type" value="3" class="md-radiobtn" checked>
                                                <label for="radio523">
                                                  <span></span>
                                                  <span class="check"></span>
                                                  <span class="box"></span> 本院发起的</label>
                                              </div>
                                              <div class="md-radio ">
                                                <input type="radio" id="radio544" name="data_type" value="4" class="md-radiobtn" checked>
                                                <label for="radio544">
                                                  <span></span>
                                                  <span class="check"></span>
                                                  <span class="box"></span> 本月接收的</label>
                                              </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-lg-12 col-md-12 form-group form-md-line-input">
                                        ...
                                        <div class="col-md-9">
                                            <div class="clearfix">
                                                ...
                                                <button type="button" onclick="search_by_treat_status('<?=$values->id?>')" class="btn blue-madison">
                                                    <?=$values->name?>
                                                </button>
                                                <?php endforeach;?>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            var tbl_usr_info = '<?=base_url()?>' + 'report/search_report?diagnosis_source=2';
