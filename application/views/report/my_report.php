                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class=" col-md-3 form-group form-md-input">
                                                <button type="button" class="btn col-md-4 blue  yellow" id="search_report_btn"><span class="glyphicon glyphicon-search"> </span>检查</button>
                                                <button type="button" class="btn col-md-offset-4 col-md-4 blue " onclick="search_clear()"><span class="glyphicon glyphicon-refresh"> </span>重置</button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
                        ...
                        <div class="portlet portlet-sortable box blue-madison portlet-datatable ">
                            <div class="portlet-title">
                                <div class="caption">
                                    ...
                                    <span class="caption-subject font-green sbold uppercase">报告列表</span>
                                </div>
                            </div>
                            <div class="portlet-body">
                                <div class="clearfix" style="margin-left: 10%;">
                                    <button type="button" class="btn blue-hoki" id="report_detail_view" disabled onclick="report_detail_view()"><span class="glyphicon glyphicon-eye-open"> </span>查看</button>
                                    <button type="button" id="dicom_view_btn" disabled class="btn blue-madison" onclick="dicom_view()"><span class="glyphicon glyphicon-picture"> </span>调图</button>
