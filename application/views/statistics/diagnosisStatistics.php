                    ...
                    <div class="col-md-12">
                        <div class="portlet portlet-sortable box blue-madison ">
                            <div class="portlet-title">
                                <div class="caption">
                                    <i class=""></i>
                                    <span class="caption-subject font-light sbold uppercase">每日诊断报告统计</span>
                                </div>
                            </div>
                            <div class="portlet-body">
                                        ...
                                        <div class="form-body">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-3 col-md-3 form-group form-md-line-input">
                                                    ...
                                                    <div class="col-lg-7 col-md-6">
                                                        <select class="form-control" id="patient_source" name="checkup_type">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <h2 style="text-align: center; color: #32c5d2;"><b>每日诊断报告统计</b></h2>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="table-scrollable">
                                            <table class="table table-striped table-bordered table-hover" id="diagnosis_table">
                                                <thead>
                                                <tr><th >序号</th><th>病人编号</th><th >姓名</th><th>性别</th><th>年龄</th><th>检查时间</th>
                                                    <th>接入医院</th><th>检查类型</th><th>报告医师</th><th>审核医师</th><th>操作</th>
                                                </tr>
                                                </thead>
                                                <tbody>
                                                </tbody>
...
<script>
    ...
    $(document).ready(function () {
        $(function () {
            $.ajax({
                url: '<?=base_url()?>' + 'statistics/get_diagnosis_amount',
                type: 'GET',
                dataType: 'json',
                data: '',
                cache: false,
...
//                                "title": "折线图",
        ...
        var tbl_usr_info = '<?=base_url()?>' + 'statistics/get_diagnosis_data';
        ...
        $("#search_btn").click(function () {
            ...
            var ajaxurl = base_url + 'statistics/search_diagnosis_data?' + formData;
            table.ajax.url(ajaxurl).load();

            $(function () {
                $.ajax({
                    url: '<?=base_url()?>' + 'statistics/search_diagnosis_amount?' + formData,
                    type: 'GET',
                    dataType: 'json',
                    data: '',
                    cache: false,
