                    ...
                    <div class="col-md-12">
                        <div class="portlet portlet-sortable box blue-madison ">
                            <div class="portlet-title">
                                <div class="caption">
                                    <i class=""></i>
                                    <span class="caption-subject font-light sbold uppercase">每日登记情况统计</span>
                                </div>
                            </div>
                            <div class="portlet-body">
                                <div class="row">
                                    <!-- BEGIN FORM-->
                                    <form action="#" method="post" class="form-horizontal" id="search_booking_form">
                                        <div class="form-body">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-2 col-md-3 form-group form-md-line-input">
                                                    <button type="button" class="pull-left btn col-md-6 green" id="search_booking_btn">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <h2 style="text-align: center; color: #32c5d2;"><b>每日登记情况统计</b></h2>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="table-scrollable">
                                            <table class="table table-striped table-bordered table-hover" id="booking_table">
                                                <thead>
                                                <tr><th >序号</th><th>病人编号</th><th >姓名</th><th>性别</th><th>年龄</th><th>登记时间</th>
                                                    <th>接入医院</th><th>病人来源</th><th>登记人员</th><th>操作</th>
                                                </tr>
                                                </thead>
...
<script>
    ...
    $(document).ready(function () {
        $(function () {
            $.ajax({
                url: '<?=base_url()?>' + 'statistics/get_booking_amount',
                type: 'GET',
                dataType: 'json',
                data: '',
                cache: false,
...
//                                "title": "折线图",
        ...
        var tbl_usr_info = '<?=base_url()?>' + 'statistics/get_booking_data';
        ...
        $("#search_booking_btn").click(function () {
            ...
            var formData = $('#search_booking_form').serialize();
            var ajaxurl = base_url + 'statistics/search_booking_data?' + formData;
            table.ajax.url(ajaxurl).load();

            $(function () {
                $.ajax({
                    url: '<?=base_url()?>' + 'statistics/search_booking_amount?' + formData,
                    type: 'GET',
                    dataType: 'json',
                    data: '',
                    cache: false,
