										...
										<div class="row">
											<div class="col-lg-3 col-md-6 form-group form-md-line-input">
												...
												<div class="col-md-8 col-lg-7">
													<input class="form-control form-control-inline " placeholder="01/01/2017" name="start_time" type="text" value="" />
												</div>
											</div>
											<div class="col-lg-3 col-md-6 form-group form-md-line-input">
												<label class="col-lg-1 control-label col-md-3">至</label>
												<div class="col-md-9 col-lg-7">
													<input class="form-control form-control-inline date-picker" placeholder="01/01/2017" name="end_time" type="text" value="" />
												</div>
											</div>
											<div class="col-lg-3 col-md-6 form-group form-md-line-input">
						...
						<div class="portlet light portlet-sortable portlet-fit portlet-datatable ">
							<div class="portlet-title">
								<div class="caption">
									...
									<span class="caption-subject font-green sbold uppercase">咨询审核</span>
								</div>
							</div>
							<div class="clearfix col-md-offset-1">
								<button type="button" onclick="contactDetail()" disabled id="contactDetail_btn" class="btn dark  sbold uppercase">
									<span class="glyphicon glyphicon-th-list"> </span>查看</button>
								<?php $usrRole = $this->session->userdata('usr_role')?>
								<?php if ($usrRole == 1 || $usrRole == 100 || $usrRole == 10 || $usrRole == 1024 || $this->session->userdata('DeliContact')): ?>
								<button type="button" onclick="DeliContact()" disabled id="contactDeli_btn" class="btn dark  sbold uppercase">
...
<script>
	...
	$(document).ready(function () {
		var tbl_usr_info = '<?=base_url()?>' + 'contact/search_my_contact/shenhe';
		...
		$('#contactDetail_btn').click(function () {
	...
	function select_contact(val) {
		...
		$('#contactDeli_btn').removeAttr('disabled');
		...
		if (val.contact_status == '3') {
			$('#contactDeli_btn').attr('disabled', 'true');
		} else {
	...
	function DeliContact() {
		var base_url = '<?=base_url()?>';
		var strURL = base_url + "contact/contactDeliPro/" + $('#contact_id').val();
		window.location.href = strURL;
	}
