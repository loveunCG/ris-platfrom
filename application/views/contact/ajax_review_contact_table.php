									...
									<div class="col-lg-12 col-md-12 form-group form-md-line-input">
										...
										<div class="col-md-6">
											<div class="clearfix">
												...
												<button type="button" onclick="search_by_contact_status(1)" class="btn  contact-button">
													未审核
												</button>
												<button type="button" onclick="search_by_contact_status(3)" class="btn contact-button">
												审核通过
												</button>
												<button type="button" onclick="search_by_contact_status(4)" class="btn  contact-button ">
													已驳回
												</button>
						...
						<table class="table table-striped table-bordered table-hover" style="text-align: center;" id="contact_review_table">
							<thead>
								<tr>
									...
									<th style="text-align: center;">申请医院</th>
...
<script>
	...
	$(document).ready(function () {
		...
		$("#search_contact_review_info").click(function () {
			...
			var ajaxurl = base_url + 'contact/search_my_contact/shenhe?' + formData;
			console.log(ajaxurl)
  ...
  function search_by_search_contact_type(contact_type){
	...
	var base_url = '<?=base_url()?>';
	var formData = $('#search_contact_review_info_form').serialize();
	var ajaxurl = base_url + 'contact/search_my_contact/shenhet?' + formData;
	table.ajax.url(ajaxurl).load();
  }
