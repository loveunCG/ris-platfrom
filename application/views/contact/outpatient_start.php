<div class="page-content-wrapper">
    <!-- BEGIN CONTENT BODY -->
    <div class="page-content" id="form_wizard_1">
        <div class="row">
            <div class="col-md-12">
                <div class="portlet box blue-chambray" id="form_wizard_1">
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <span class="caption-subject font-light bold uppercase">远程门诊 <span class="step-title"></span>
                            </span>
                        </div>
                        <div class="actions">
                                        ...
                                        <div class="tab-pane active" id="tab1">
                                            ...
                                            <div class="row" style="padding-bottom: 2%">
                                                <div class="col-xs-12 col-sm-3 col-lg-3">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" class="form-control" onchange="search_patient_info(this.value)" name="patient_code" id="patient_code"
                                                        />
                                                    </div>
                                                </div>
                                                <div class="col-xs-12 col-sm-9 col-lg-9">
                                                    <div class="form-group col-md-3 ">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input type="text" class="form-control" readonly name="patient_name" id="patient_name" />
                                                        </div>
                                                    </div>
                                                    <div class="form-group col-md-3 ">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input type="text" class="form-control" readonly name="patient_gender" id="patient_gender" />
                                                        </div>
                                                    </div>
                                                    <div class="form-group col-md-3 ">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input type="text" class="form-control" readonly name="patient_age" id="patient_age" />
                                                        </div>
                                                    </div>
                                                    <div class="form-group col-md-3 ">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input type="text" class="form-control" readonly name="license_num" id="license_num" />
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-xs-12 col-sm-3 col-lg-3">
                                                    <form method="post" enctype="multipart/form-data" id="form_upload_doc">
                                                        <div class="col-md-offset-2 col-md-9  form-group">
                                                            <div class="col-md-offset-5  fileinput fileinput-new" data-provides="fileinput">
                                                                ...
                                                                <input type="hidden" id="upload_doc_file_path" value="" name="upload_doc_file_path">
                                                                <input
                                                                    type="file" id="upload_doc" name="upload_doc">
                                                                    </span>
                                                    ...
                                                    <div class="col-md-offset-2 col-md-9 form-group">
                                                        <div class="col-md-offset-5  fileinput fileinput-new" data-provides="fileinput">
                                                            ...
                                                            <span class="fileinput-exists"> 换一下 </span>
                                                            <input type="hidden" value="" id="upload_dicom_file_path" name="upload_dicom_file_path">
                                                            <input
                                                                type="file" id="upload_dicom" name="upload_dicom"> </span>
                                                                <span class="fileinput-filename"></span> &nbsp;
                                                                <a href="javascript:;" class="close fileinput-exists" data-dismiss="fileinput"> </a>
                                                ...
                                                <div class="col-xs-12 col-sm-9 col-lg-9">
                                                    ...
                                                    <div class="row" style="margin-top: 2%;">
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <div class="col-md-10">
                                                                <textarea class="form-control" name="disease_summary" id="disease_summary" rows="5"></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <div class="col-md-10">
                                                                <textarea class="form-control" name="medical_history" id="medical_history" rows="5"></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <div class="col-md-10">
                                                                <textarea class="form-control" name="contact_problem" id="contact_problem" rows="5"></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-3 form-group form-md-line-input">
                                                    ...
                                                    <div class="col-md-7">
                                                        <div class="input-group form-md-line-input">
                                                            <input type="text" name="set_date" id="to" class="form-control">
...
<script>
    ...
    function submit_contact() {
        if ($('#set_hospital').val() == '' || $('#set_class').val() == '' || $('#set_date').val() == '' || $(
            ...
            alert(form_data) //Encode form elements for submission
            $.ajax({
                url: url,
                type: 'post',
                dataType: "JSON",
