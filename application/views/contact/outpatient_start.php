					...
					<div class="portlet box portlet-sortable blue-chambray" id="form_wizard_1">
						<div class="portlet-title">
							<div class="caption">
								...
								<span class="caption-subject font-light bold uppercase"> 远程门诊
											...
											<div class="tab-pane active" id="tab1">
												...
												<div class="row">
													...
													<div class="form-group col-md-6 col-lg-2">
														...
														<div class="col-md-9 col-lg-7">
															<input type="text" class="form-control" readonly value="<?=$contact_info->patient_gender=='0' ? '男':$contact_info->patient_gender=='1'?'女':''?>"
											...
											<div class="tab-pane" id="tab2">
												<div class="row">
													...
													<div class="col-md-3 form-group form-md-line-input">
														...
														<div class="col-md-7">
															<select class="form-control" name="set_hospital" id="set_hospital">
																...
																<option value="<?=$value->hospital_name?>" <?=$contact_info->set_hospital==$value->hospital_name?'selected':''?>>
																	<?=$value->hospital_name?>
																</option>
																<?php }?>
															</select>
													...
													<div class="col-md-3 form-group form-md-line-input">
														...
														<div class="col-md-7">
															...
															<input type="hidden" name="contact_type" value="<?=$contact_info->contact_type == null ? $contact_type: $contact_info->contact_type ?>"
															/>
														</div>
													</div>
												...
												<div class="row">
													...
													<div class="col-md-6 form-group form-md-line-input">
														<label class="col-md-1 control-label" for="form_control_1">日期:</label>
														<div class="col-md-7">
															<div class="input-group date form_datetime form-md-line-input">
																<input type="text" name="set_check_time" id="set_check_time" size="16" value="<?=$contact_info->set_check_time?>" readonly
																class="form-control" />
