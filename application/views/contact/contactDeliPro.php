            ...
            <div class="col-md-12">
                <div class="portlet light portlet-sortable">
                    ...
                    <div class="portlet-body">
                        ...
                        <div class="row well">
                            <center>
                                <button type="button" class="btn blue col-md-offset-3 col-md-2" onclick="window.history.go(-1)"><span class="glyphicon glyphicon-arrow-left"> </span>返回</button>
                                <button type="button" class="btn green col-md-2" onclick="AnPaihuiZhen()"><span class="glyphicon glyphicon-eye-open"> </span>安排会诊</button>
                                <button type="button" class="btn red col-md-2" onclick="RejrctHuiZhen()"><span class="glyphicon glyphicon-ban-circle"> </span>拒绝</button>
                            </center>
                        </div>
                    </div>
                </div>
