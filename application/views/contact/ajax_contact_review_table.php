								...
								<div class="row">
									<div class="col-lg-3 col-md-6 form-group form-md-line-input">
										...
										<div class="col-md-8 col-lg-7">
											<input class="form-control form-control-inline date-picker" placeholder="01/01/2017" name="start_time" type="text" value=""
											/>
										</div>
									</div>
									<div class="col-lg-3 col-md-6 form-group form-md-line-input">
									...
									<div class=" col-lg-3 col-md-6 form-group form-md-input">
										<button type="button" class="btn col-md-offset-2 col-md-4 contact-button" id="search_contact_review_info">
											<i class="fa fa-search"></i>查询</button>
										<button type="button" class="btn col-md-offset-2 col-md-4 contact-button" onclick="search_clear()">
