<div class="page-sidebar navbar-collapse collapse" >
    <ul class="page-sidebar-menu  page-header-fixed page-sidebar-menu-hover-submenu  page-sidebar-menu-closed" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
        <li class="nav-item <?=($menutitle == $this->lang->line('usermg')) ? 'start active open' : ''; ?>">
            ...
            <ul class="sub-menu">
                <?php if (check_role('isAvailableUser')): ?>
                <li class="nav-item">
                ...
                <?php endif; ?>
                <?php if (check_role('isAvailablePatient')): ?>
                <li class="nav-item">
                ...
                <?php endif; ?>
                <?php if (check_role('isAvailableDevice')): ?>
                <li class="nav-item  ">
                ...
                <?php endif; ?>
                <?php if (check_role('isAvailableItemList')): ?>
                <li class="nav-item  ">
                ...
                <?php endif; ?>
                <?php if (check_role('isAvailableHospital')): ?>
                <li class="nav-item  ">
        ...
        <li class="nav-item <?='statistics' == $this->uri->segment(1) ? 'start active open' : ''; ?>">
            <a href="javascript:;" class="nav-link nav-toggle">
