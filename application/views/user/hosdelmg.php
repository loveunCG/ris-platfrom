				...
				<div class="portlet portlet-sortable box blue-madison">
					<div class="portlet-title">
						<div class="caption">
							...
							<span class="caption-subject font-white sbold uppercase">子医院审核</span>
						</div>
					</div>
				...
				<div class="portlet portlet-sortable box  blue-madison ">
					<div class="portlet-title">
						<div class="caption">
							...
							<span class="caption-subject font-white sbold uppercase">医院列表</span>
						</div>
						<div class="actions">
					...
					<div class="portlet-body">
						...
						<div class="clearfix">
							...
							<div class="row">
							<?php if ($usrRole == 1 || $usrRole == 1024 || $this->session->userdata('isAvailableReview')): ?>
