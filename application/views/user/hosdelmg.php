<div class="page-content-wrapper">
            ...
            <div class="col-md-12 column sortable">
                ...
                <div class="portlet portlet-sortable box blue-steel">
                    ...
                    <div class="portlet-body">
                        <!-- BEGIN FORM-->
                        <form action="#" method="post" id="search_hospital_form" class="form-horizontal" novalidate>
                            <div class="form-body">
                                ...
                                <div class="row">
                                    <div class="col-md-3 form-group form-md-line-input">
                                        <label class="col-md-3 control-label" for="form_control_1">医院编号 :                                          </label>
                                        <div class="col-md-9">
                                    ...
                                    <div class="col-md-3 form-group form-md-line-input">
                                        <label class="col-md-3 control-label" for="form_control_1">医院名称:
                                                </label>
                                        <div class="col-md-9">
                        ...
                        <div class="clearfix">
                            ...
                            <div class="row">
                                <div class="col-md-offset-1 col-md-2">
                                    <button type="button" class="btn green-haze pull-left" data-target="#add_user" disabled id="hospital_deliberation" data-toggle="modal"><span class="glyphicon glyphicon-envelope"> </span>审核</button>
                                </div>
                                <div id="add_user" class="modal fade" tabindex="-1" data-focus-on="input:first">
                                    <div class="portlet portlet-sortable box blue">
                                        <div class="portlet-title">
                                            ...
                                            <div class="actions">
                                                <a data-dismiss="modal" class="btn btn-circle btn-icon-only" href="javascript:;">
                                        ...
                                        <div class="portlet-body">
                                            ...
                                            <form action="#" method="post" id="hospital_deli">
                                                ...
                                                <div class="form-body col-md-12">
                                                    ...
                                                    <div class="row col-md-12 ">
                                                        <div class="form-group  col-md-12 form-md-line-input">
                                                            <input type="text" class="form-control"  readonly id="location_sheng" name="location_sheng"></select>
                                                            <label for="form_control_1">所属省会</label>
                                                        </div>
                                                        <div class="form-group  col-md-12 form-md-line-input">
                                                            <input type="text" class="form-control" id="location_city" name="location_city"></select>
                                                    ...
                                                    <div class="row col-md-12">
                                                        <div class="form-group form-md-line-input ">
                                                            <select class="form-control" id="deli_recommend" name="deli_recommend">
                                                                        ...
                                                                        <option value="2">没通过</option>
                                                                        <option value="3">未</option>
                                                                    </select>
                                                ...
                                                <div class="form-actions">
                                                    <div class="row">
                                                        <div class="col-md-offset-1 col-md-9">
                                                            <button type="submit" id="submit_button" class="btn blue-soft pull-left"><span class="glyphicon glyphicon-send"> </span>审核</button>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            var table = $('#hospital_req_table').DataTable({
                "ajax": hospital_req,
                select: true,
                'searching': false,
