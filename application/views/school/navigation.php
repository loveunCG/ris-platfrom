...
<div class="page-container">
    <div class="page-sidebar-wrapper">
        ...
        <?php if($this->session->userdata('usr_role')==1||$this->session->userdata('usr_role')==10||$this->session->userdata('usr_role')==1024||$this->session->userdata('usr_role')==2||$this->session->userdata('usr_role')==100){
