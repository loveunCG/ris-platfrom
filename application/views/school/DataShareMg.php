<link rel="stylesheet" type="text/css" href="<?=base_url()?>assets/elfinder/css/elfinder.min.css">
<link rel="stylesheet" type="text/css" href="<?=base_url()?>assets/elfinder/css/theme.css">
    ...
    $('#elfinder').elfinder(
        {
            ...
            url: '../assets/elfinder/php/connector.minimal.php?dir_name=<?=$this->session->userdata('hospital_name')?>',
