				...
				<div class="portlet portlet-sortable box blue-madison">
					<div class="portlet-title">
						<div class="caption">
							...
							<span class="caption-subject font-white sbold uppercase">学习管理</span>
						</div>
					</div>
					<div class="portlet-body">
						<!-- BEGIN FORM-->
						<form action="#" method="post" class="form-horizontal" id="search_lession_form">
							<div class="form-body">
								<div class="row">
									<div class="col-md-3 col-lg-3 form-group form-md-line-input">
										<label class="col-md-5 col-lg-3 control-label" for="form_control_1">课程类型 </label>
									...
									<div class="col-md-3 form-group form-md-line-input">
										...
										<div class="col-md-9">
											<input class="form-control form-control-inline input-medium date-picker" data-date-format="yyyy-mm-dd" name="start_time"
											size="20" type="text" />
									...
									<div class="col-md-3 form-group form-md-line-input">
										...
										<div class="col-md-9">
											<input class="form-control form-control-inline input-medium date-picker" data-date-format="yyyy-mm-dd" name="end_time" size="20"
											type="text" />
											<span class="help-block"> 选择日期 </span>
										</div>
									</div>
								...
								<div class="row">
									<div class="col-md-offset-8 col-md-3">
										<button type="button" class="btn  pull-left yellow" id="search_device_btn">
											<i class="fa fa-search"></i>查询</button>
										<button type="button" class="btn  blue pull-right" onclick="search_clear()">
				...
				<div class="portlet portlet-sortable box  blue-madison ">
					<div class="portlet-title">
						<div class="caption">
							...
							<span class="caption-subject font-white sbold uppercase">设备列表</span>
						</div>
						<div class="actions">
					...
					<div class="portlet-body">
						...
						<div class="clearfix" style="margin-left: 10%;">
							<div class="row">
								<button type="button" class="btn green-haze" data-target="#add_lesssion" data-toggle="modal">
								...
								<div id="add_lesssion" class="modal fade" tabindex="-1" data-focus-on="input:first">
									<div class="portlet portlet-sortable box blue portlet-fit portlet-form">
										<div class="portlet-title">
											<div class="caption">
												<span class="glyphicon glyphicon-plus"> </span>
												<span class="caption-subject font-light sbold uppercase">新增课程</span>
											</div>
											<div class="actions">
														...
														<form id="form_add_lession">
															...
															<div class="col-md-12">
																...
																<div class="form-group col-md-6 form-md-line-input ">
																	...
																	<select class="form-control" name="lession_doctor">
																		<option value="">请选择</option>
																		<?php
foreach ($user_info as $values) {
	echo '<option value = "' . $values->id . '">' . $values->usr_name . '</option>';
}
?>
																	</select>
												...
												<div class="well">
													<div class="row">
														...
														<div class="col-md-12" style="padding: 3%;">
															<button type="button" id="form_add_lession_tbn" class="btn blue-soft pull-left">
																<span class="glyphicon glyphicon-ok"> </span>添加</button>
															<a onclick="AddUserClose()" data-dismiss="modal" class="btn blue-soft pull-right">
								...
								<button type="button" class="btn yellow-mint" disabled id="edit_lession_btn" data-target="#edit_user_data" data-toggle="modal">
									<span class="glyphicon glyphicon-edit"> </span>编辑</button>
								<div id="edit_user_data" class="modal fade" tabindex="-1" data-focus-on="input:first">
									<div class="portlet portlet-sortable box blue sortable">
										<div class="portlet-title">
											<div class="caption">
												<span class="caption-subject font-light sbold uppercase">
													<span class="glyphicon glyphicon-pencil"> </span>修改信息</span>
											</div>
											<div class="actions">
												<a data-dismiss="modal" class="btn btn-circle btn-icon-only btn-light" href="javascript:;">
													<i class="fa fa-close"></i>
													...
													<div class="row">
														<form id="update_lession_form">
															...
															<div class="col-md-12">
																...
																<div class="form-group col-md-6 form-md-line-input ">
																	<select class="form-control" id="lession_doctor" name="lession_doctor">
																		<option value="">请选择</option>
																		<?php
foreach ($user_info as $values) {
	echo '<option value = "' . $values->id . '">' . $values->usr_name . '</option>';
...
?>
												...
												<div class="well">
													<div class="row">
														...
														<div class="col-md-12" style="padding: 3%;">
															<button type="button" id="equipment_update_bn" class="btn blue-soft pull-left">
																<span class="glyphicon glyphicon-edit"> </span>编辑</button>
															<a onclick="EditClose()" data-dismiss="modal" class="btn blue-soft pull-right">
								...
								<button type="button" class="btn red-thunderbird" data-target="#delete_lession" data-toggle="modal" disabled id="delete_lession_btn">
	...
	<script>
		function select_lession(val) {
			...
			$('#lession_doctor').val(val.id).change();
		...
		function AddUserClose() {
			$('#form_add_lession').find('.help-block-error').remove();
			$('#form_add_lession').find('.form-group').removeClass('has-error');
		}

		function EditClose() {
			$('#update_lession_form').find('.help-block-error').remove();
			$('#update_lession_form').find('.form-group').removeClass('has-error');
		}
